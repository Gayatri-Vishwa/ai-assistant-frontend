...
//   const [status, setStatus] = useState("Sleeping"); // Listening / Speaking / Pausing / Sleeping
...
//     const { type, userInput, response: resText } = data;
//     const response = resText || "Okay";
//     speak(response);
...
//   // ---------------- Debounced API ----------------
//   const handleInput = debounce(async (command) => {
//     if (!command || command.length < 3) return;

//     try {
//       const res = await fetch("/api/user/asktoassistant", {
//         method: "POST",
...
//       setUserData((prev) => prev ? { ...prev, history: [...(prev.history || []), command] } : prev);
...
//       isRecognizingRef.current = false;
//       setStatus("Sleeping");
//       if (isMounted) setTimeout(startRecognition, 1500);
//     };
...
//   // ---------------- UI ----------------
//   return (
//     <div className="w-full min-h-screen bg-gradient-to-t from-black to-[#04044d] flex flex-col items-center p-6 gap-4">
//       <h1 className="text-white text-2xl font-bold">
//         Assistant Status:{" "}
//         <span className={status === "Listening" ? "text-green-400" :
//                          status === "Speaking" ? "text-blue-400" : "text-yellow-400"}>
//           {status.toUpperCase()}
//         </span>
//       </h1>

//       <div className="w-[300px] h-[400px] flex justify-center items-center">
//         {!aiText && <img src={userImg} alt="" className="h-full w-full object-cover" />}
//         {aiText && <img src={aiImg} alt="" className="h-full w-full object-cover" />}
//       </div>

//       <h2 className="text-white text-xl font-semibold">
//         {userText ? `You: ${userText}` : aiText ? `AI: ${aiText}` : ""}
//       </h2>
...
//             <p key={idx} className="text-gray-200 ml-4">{idx + 1}. {his}</p>
//           ))}
//         </div>
//       )}
//     </div>
...
// //   return (
// //     <div className="w-full min-h-screen  bg-gradient-to-t  from-black to-[#04044d] flex flex-col gap-[15px] justify-center items-center p-6 ">
// //       {showHistory ? (
...
// //             )}
// //           </div>
// //           <h1 className="text-white text-xl font-semibold text-center w-[70%] mx-auto mb-[10px] ">
